...
export class PdfService {
  ...
  CertificadoDeclaracion(data: any, Qr: any, TokenQr: any) {
    ...
    doc.setFontSize(12);
    doc.text("SANTIAGO LEON SANDOVAL BASTARDO", 105, 195, { align: "center" });
    doc.setFontSize(10);
