...
import { Email } from 'app/main/dashboard/email/email.model';
...
export class EmailService implements Resolve<any> {
  ...
  updateSearchText(value: string) {
    if (value !== undefined && value !== null) {
      if (this.labelHandle === '') {
        this.router.navigate(['/email/' + this.folderHandle], { queryParams: { q: value } });
      } else {
        this.router.navigate(['/email/label/' + this.labelHandle], { queryParams: { q: value } });
      }
      if (value === '' && this.labelHandle === '') {
        this.router.navigate(['/email/' + this.folderHandle], {});
      } else if (value === '' && this.labelHandle !== '') {
        this.router.navigate(['/email/label/' + this.labelHandle], {});
      }
