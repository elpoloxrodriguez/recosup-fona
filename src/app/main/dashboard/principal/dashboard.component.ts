    ...
    await this.apiService.Ejecutar(this.xAPI).subscribe(
      (data) => {
        ...
        this.donusChart02 = {
          ...
          datasets: [
            {
              data: [data.Cuerpo[0].MIF_Pagadas ? data.Cuerpo[0].MIF_Pagadas : 0, data.Cuerpo[0].MIF_Revision ? data.Cuerpo[0].MIF_Revision : 0, data.Cuerpo[0].MIF_SinPagar ? data.Cuerpo[0].MIF_SinPagar : 0, data.Cuerpo[0].MIF_Rechazados ? data.Cuerpo[0].MIF_Rechazados : 0, data.Cuerpo[0].ENI_Pagada ? data.Cuerpo[0].ENI_Pagada : 0, data.Cuerpo[0].ENI_SinPagar ? data.Cuerpo[0].ENI_SinPagar : 0],
              label: `EMPRESAS DOBLE APORTANTES`,
            },
          ]
        }
